...
<a class="btn btn-outline-info" href="https://robinkarlsson-se.translate.goog/?_x_tr_sl=sv&_x_tr_tl=en&_x_tr_hl=sv&_x_tr_pto=wapp" role="button">View this site in another language</a><br><br>
    ...
    <p>Grundare & Systemutvecklare @ <a href="https://Thalarion.se" style='text-decoration: none;'>Thalarion.se</a></p>
...
function Ommig() {
  OmmigContent.innerHTML = `
    ...
    <div>
    <span class="badge bg-secondary">Thalarion.se (Grundare & Systemutvecklare)</span></h3>
        <u><br>2024-nu <b style="color:green;">(Fritid/Hobby)</b><br></u>
            Thalarion - Byggd med React (Mantine UI + Jotai), Go med Fiber som backend och MongoDB Atlas som databas
        <br><br>
    </div>
    </div>
    <div class="flex-Arblf">
